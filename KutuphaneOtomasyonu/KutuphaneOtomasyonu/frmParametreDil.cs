...
{
    public partial class frmParametreDil : Form
    {
        public frmParametreDil()
        {
            InitializeComponent();
        }
        ...
        private void id()
        {
            clsParametreDil a = new clsParametreDil();
            a.hazirid();
            txtid.Text = a.zDgr;
        ...
        {
            clsParametreDil a = new clsParametreDil();
            dgwdil.DataSource = a.datagrdDoldur();
        }

        private void frmParametreDil_Load(object sender, EventArgs e)
        {
            datagrdDoldur();
            id();
        }
